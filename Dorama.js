(function () {
     ...
     * Дорама / Asian Dramas
     * Версія: 1.0.0
     * Опис: Добірки популярних дорам (корейські, китайські, японські тощо)
     */

    var DORAMA_CONFIG = {
        'dorama': {
            title: 'Дорама',
            icon: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.94-.49-7-3.85-7-7.93s3.06-7.44 7-7.93V17.93zm2-13.86c3.94.49 7 3.85 7 7.93s-3.06 7.44-7 7.93V4.07z"/></svg>', // можна замінити на кращий іконку серця або корейського стилю
            categories: [
                // Найпопулярніші дорами взагалі (корейська + китайська + японська + інші)
                {
                    "title": "Популярні дорами зараз",
                    "url": "discover/tv",
                    "params": {
                        "with_original_language": "ko|zh|ja",
                        "with_genres": "18",                    // драма
                        "sort_by": "popularity.desc",
                        "vote_count.gte": "30"
                    }
                },

                // Новинки корейських дорам
                {
                ...
                // Топ за рейтингом (найкращі дорами)
                {
                ...
                // Романтика / Мелодрами
                {
                    ...
                    "params": {
                        "with_original_language": "ko|zh|ja",
                        "with_genres": "18,10749",           // драма + романтика
                        "sort_by": "popularity.desc"
                    }
                },

                // Фентезі / Історичні / Костюмовані
                {
                    "title": "Історичні та фентезі дорами",
                    "url": "discover/tv",
                    "params": {
                        "with_original_language": "ko|zh|ja",
                        "with_genres": "10765,37",           // sci-fi/fantasy + historical
                        "sort_by": "popularity.desc"
                    }
                },

                // Китайські дорами (C-drama)
                {
                ...
                // Якщо хочете прив’язати до конкретних платформ (Viki, iQIYI тощо)
                // зауваження: ідентифікатори можуть змінюватися, краще перевірити актуальні значення
                // Viki ≈ 126 (Rakuten Viki), iQIYI ≈ 1006 або 2008 (перевірити)
                {
    ...
    // ────────────────────────────────────────────────
    // Компоненти (майже без змін від вашого коду)
    // ────────────────────────────────────────────────
    ...
    function startPlugin() {
        ...
        // CSS (широкі картки, як у вашому плагіні)
        ...
        // на випадок динамічного оновлення меню
